// src/domain/services/BodyMeasurer.ts
...
export class BodyMeasurer {
    ...
    static getChestCircumference(mesh: THREE.Mesh): number {
        ...
        // Chest is typically at ~72-75% of total height
        ...
        for (let i = 0; i < pos.count; i++) {
            ...
            // Apply world transform if needed, but usually we measure raw geometry
            // mesh.localToWorld(v);
        ...
        // 2. Compute Convex Hull (Jarvis March / Gift Wrapping simplified)
        // For a dense slice, a simple sort by angle around centroid works well enough for estimation
