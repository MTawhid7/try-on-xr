// src/domain/services/TextureGenerator.ts
...
export class TextureGenerator {
    static generateFabricNormal(): THREE.CanvasTexture {
        ...
        // CRITICAL FIX: Disable Color Management for Normal Maps
        // This prevents the "LCD Glow" caused by double-gamma correction
