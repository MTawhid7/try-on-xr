// src/infrastructure/geometry/analysis/slice/ClusterEngine.ts
...
export class ClusterEngine {
    /**
     * Groups a cloud of points into distinct clusters using a Grid-Based Union-Find algorithm.
     * O(N) complexity.
     */
    static findClusters(points: THREE.Vector3[], cellSize: number = 0.05): Cluster[] {
        ...
        // 3. Merge Neighbors (8-way connectivity)
