...
/**
 * Represents a distinct group of points (an "island" of geometry).
 * Generated by the ClusterEngine during slice analysis.
 */
...
/**
 * A high-performance spatial clustering engine.
 * Groups 3D points into distinct clusters based on proximity.
 * Used to detect separate body parts (e.g., Left Leg, Right Leg) in a cross-section slice.
 */
export class ClusterEngine {
     ...
     * O(N) complexity.
     *
     * @param points - The array of 3D points to cluster.
     * @param cellSize - The size of the grid cells for spatial hashing (default 0.05m).
     */
