...
export class GeometryProcessor {
    /**
     * Cleans up a mesh for physics simulation.
     * 1. Welds vertices (merges duplicates) to ensure the cloth doesn't fall apart at seams.
     * 2. Recomputes normals.
     * 3. Recovers UVs (lost during welding) for texturing.
     * 4. Computes Tangents (required for Anisotropic materials).
     */
    static process(mesh: THREE.Mesh, weldThreshold: number = GEOMETRY_WELD_THRESHOLD): ProcessedMesh {
